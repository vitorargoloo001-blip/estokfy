-- =====================================================================
-- Correção: a seção pedida para o Painel do vendedor era "Resumo por tipo
-- de produto vendido" (quantidade por categoria, como em Relatórios), não
-- o breakdown por forma de pagamento adicionado por engano na migration
-- anterior. Troca today_payment_methods por today_by_category (qty +
-- revenue por categoria, hoje, escopado ao próprio vendedor).
-- =====================================================================
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'today_by_category', v_today_by_category,
