-- =====================================================================
-- Dashboard do vendedor: adiciona o valor total (não só a contagem) das
-- vendas de hoje por forma de pagamento (PIX e Dinheiro). Soma o valor do
-- pagamento (payments.amount), não o net_total da venda — correto também
-- para vendas com pagamento dividido (ex: metade PIX, metade dinheiro).
-- =====================================================================
