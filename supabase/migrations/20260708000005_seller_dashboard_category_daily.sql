-- =====================================================================
-- Ajuste: "Resumo por tipo de produto vendido" no Painel do vendedor
-- volta a ser diário (não mensal). Mesmo filtro created_by = o próprio
-- perfil (isolamento entre vendedores inalterado).
-- =====================================================================
