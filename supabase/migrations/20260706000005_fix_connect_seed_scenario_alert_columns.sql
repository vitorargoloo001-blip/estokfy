-- =====================================================================
-- Fix: os 2 últimos INSERTs em connect_alerts declaravam 5 colunas
-- (store_id, alert_type, severity, title, message) mas passavam 6
-- valores (sobrava um '' extra) — "INSERT has more expressions than
-- target columns". Também pré-existente desde a migration original,
-- só exercitado agora que os bugs anteriores (account_number,
-- account_type, GET DIAGNOSTICS) foram corrigidos.
-- =====================================================================
