-- =====================================================================
-- Fix: connect_seed_scenario_completo nunca preenchia account_number ao
-- criar as 3 conexões de sandbox, violando o NOT NULL de bank_connections.
-- Reproduzido ao clicar "Gerar cenário completo" em /connect.
-- =====================================================================
...
BEGIN
  ...
  INSERT INTO public.bank_connections (id, store_id, bank_name, bank_code, account_number, account_holder, status, is_active, last_sync_at)
  VALUES (gen_random_uuid(), p_store_id, 'Banco PIX Sandbox', '077', '****1001', 'LOJA DEMO LTDA', 'connected', true, now())
  RETURNING id INTO v_conn_pix;

  INSERT INTO public.bank_connections (id, store_id, bank_name, bank_code, account_number, account_holder, status, is_active, last_sync_at)
  VALUES (gen_random_uuid(), p_store_id, 'Cartão Sandbox', '341', '****1002', 'LOJA DEMO LTDA', 'connected', true, now())
  RETURNING id INTO v_conn_card;

  INSERT INTO public.bank_connections (id, store_id, bank_name, bank_code, account_number, account_holder, status, is_active, last_sync_at)
  VALUES (gen_random_uuid(), p_store_id, 'Dinheiro/Boleto Sandbox', '001', '****1003', 'LOJA DEMO LTDA', 'connected', true, now())
